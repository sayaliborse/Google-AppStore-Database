						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									...
									$sql2 = "select App_Icon from appinfo ai join application a on ai.App_ID =a.App_ID join review r on r.App_ID = a.App_ID where r.Rating = 5";
									$sql = "select App_Name,Rating from application a join review r on a.App_ID =r.App_ID where r.Rating = 5";
									$sql1 = "select DevName from application a join developer d on a.Dev_ID =d.Dev_ID join review r on r.App_ID = a.App_ID where r.Rating = 5";
