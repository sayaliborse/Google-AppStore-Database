...
<!DOCTYPE html>
<? php
include("C:\wamp64\www\db_project\app_store\functions.php");
...
<body>
	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Your Top Apps
			...
			<div class="side-bar col-md-3">
				...
				<div class="range">
						<a href="#" data-toggle="modal" data-target="#New_App_Modal">Add New Application</a>
				</div>
				<div class="range">
						<a href="#" data-toggle="modal" data-target="#Update_App_Modal">Update Application</a>
				</div>
				<div class="range">
						<a href="#" data-toggle="modal" data-target="#Remove_App_Modal">Remove Application</a>
				</div>
				<div class="range">
				...
				<div class="range">
					<a href="#" data-toggle="modal" data-target="#Delete">Delete Account</a>
				</div>
				<div class="range">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="images/whatsapp.png" alt="" align = "left">
...
<!-- New Application Modal-->
	<div class="modal fade" id="New_App_Modal" tabindex="-1" role="dialog">
		<div class="modal-dialog">
			<!-- Modal content-->
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						<h3 class="agileinfo_sign">Add New Application</h3>
						<form action="addapp.php" method="post">
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="Application Name" name="App_Name" required="">
							</div>
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="Description" name="App_Desc" required="">
							</div>
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="Application Icon " name="App_Icon" required="">
							</div>
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="Application Size" name="App_SS_1" required="">
							</div>
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="Application Screenshot" name="App_SS_2" >
							</div>
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="Application Price" name="App_Price" required="">
							</div>
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="Application Version" name="App_Version" required="">
							</div>
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="OS Supported" name="OS_supp" required="">
							</div>
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="RAM Supported" name="RAM_supp" required="">
							</div>
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="Release Date" name="Release_date" required="">
							</div>
							<div class="styled-input agile-styled-input-top">
...
<!-- Update Application Modal-->
	<div class="modal fade" id="Update_App_Modal" tabindex="-1" role="dialog">
		<div class="modal-dialog">
			<!-- Modal content-->
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						<h3 class="agileinfo_sign">Update Existing Application</h3>
...
<!-- Remove Application Modal-->
	<div class="modal fade" id="Remove_App_Modal" tabindex="-1" role="dialog">
		<div class="modal-dialog">
			<!-- Modal content-->
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						<h3 class="agileinfo_sign">Remove Existing Application</h3>
			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						...
						<form action="developeraccountdetails.php" method="post">
							<div class="styled-input agile-styled-input-top">
			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						...
						<form action="editdeveloperinfo.php" method="post">
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="Name" name="Name" required="">
							</div>
							<div class="styled-input agile-styled-input-top">
