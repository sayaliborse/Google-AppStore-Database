...
<body>
			...
			<div class="col-md-5 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/whatsapp_1.png">
								<div class="thumb-image">
									<img src="images/whatsapp_1.png" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="images/whatsapp_2.jpg">
								<div class="thumb-image">
									<img src="images/whatsapp_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
			...
			<div class="col-md-7 single-right-left simpleCart_shelfItem">
				...
				<div class="product-single-w3l">
					<p>
							...
							WhatsApp uses your phone's Internet connection to let you message and call friends and family.
					</p>
					<ul>
						<li>
							No FEES.
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<h2 align="right"> Nice App </h2>
											
								</div>
								<div class="men-thumb-item">
									<p style="width: 500px;"> 
										<img src="images/user.png" alt="" style="float: left ;">
										One of the best apps I have ever seen!!!!.
									</p>		
								</div>
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Rishi Hemwani</a>
									</h4>
	...
	<div class="featured-section" id="projects">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Similar Apps
